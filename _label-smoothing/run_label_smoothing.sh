...
# ############# test 2 #############
# # control group
CUDA_VISIBLE_DEVICES=2 python trainer_label_smoothing2.py --model resnet34 --batch_size 16 --lr 2.5e-4 --epochs 100 --scheduler no --pretrained no --label_smoothing_const 0.0 --transfer_learning_scheme no --dropout yes
CUDA_VISIBLE_DEVICES=2 python trainer_label_smoothing2.py --model resnet50 --batch_size 16 --lr 2.5e-4 --epochs 100 --scheduler no --pretrained no --label_smoothing_const 0.0 --transfer_learning_scheme no --dropout yes
